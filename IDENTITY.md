...
This workspace already has a hand-maintained `docs/DEV_GUIDE.md` and `README.md`. Those are canonical for *how to use* the project. IDENTITY.md is the **map** — where things live and what not to touch. Read it first, then route via `CONTEXT.md`. `CLAUDE.md` is auto-generated from this file — edit IDENTITY.md, not CLAUDE.md.
...
├── CLAUDE.md                 # Auto-generated from IDENTITY.md. Do not edit directly.
...
4. **`docs/DEV_GUIDE.md` and `README.md` are canonical** for usage and dev tasks. IDENTITY.md / CONTEXT.md route to them; they do not replace them. If a fact lives in DEV_GUIDE.md, link to it — don't duplicate. `CLAUDE.md` is auto-generated from IDENTITY.md — never edit it directly.
